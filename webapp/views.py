...
def index_view(request):
    ...
    return render(request, 'index.html', {'products': products, 'form': form, 'categories': CATEGORIES_CHOICES})
...
def product_by_category_view(request, category):
    ...
    return render(request, 'product_by_category.html', {'products': products, 'form': form, 'category': name_category})
